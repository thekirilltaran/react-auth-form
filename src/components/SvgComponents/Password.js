...
function PasswordShow({ width = 24, height = 24, className = "", onClick }) {
  return (
    <svg
      width={width}
      height={height}
...
export const SvgPasswordShow = React.memo(PasswordShow);

function SvgPasswordHide({ width = 24, height = 24, className = "", onClick }) {
  return (
    <svg
      width={width}
      height={height}
...
export default React.memo(SvgPasswordHide);
